                            ...
                            @foreach ($data as $item)
                                <tr>
                                    ...
                                    <td class="align-middle">
                                      ...
                                      @elseif ($item->item->type == 'accept' || $item->status == 'accept')
                                        <button class="btn btn-info btn-sm text-white">{{ $item->status }}</button>
                                      @elseif ($item->item->type == 'proses' || $item->status == 'proses')
                                        <button class="btn btn-warning btn-sm text-white">{{ $item->status }}</button>
                                      @endif
                                    </td>
                                </tr>
                            @endforeach
